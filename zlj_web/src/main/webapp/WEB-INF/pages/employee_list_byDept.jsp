                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <nav class="pagination-outer" aria-label="Page navigation">
                                <ul class="pagination">
                                    <li class="page-item">
                                        <a href="${pageContext.request.contextPath}/employee/listByDepartmentName?pageNum=${pageInfo.prePage}" class="page-link" aria-label="Previous">
                                            <span aria-hidden="true">«</span>
                                        </a>
                                    </li>

                                    <c:forEach var="index" begin="1" end="${totalPage}">
                                        <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/employee/listByDepartmentName?pageNum=${index}">${index}</a></li>
                                    </c:forEach>


                                    <li class="page-item">
                                        <a href="${pageContext.request.contextPath}/employee/listByDepartmentName?pageNum=${pageInfo.nextPage}" class="page-link" aria-label="Next">
                                            <span aria-hidden="true">»</span>
                                        </a>
                                    </li>
                                </ul>
